...
public class JframeRegistro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 550, 230));

        jNombre.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jNombre.setText("Estudiante");
        getContentPane().add(jNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, -1, -1));

        jFecha.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jFecha.setText("Fecha de Nacimiento");
        getContentPane().add(jFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, -1, 20));

        jCodigo.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jCodigo.setText("Codigo Estudiante");
        getContentPane().add(jCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, -1, -1));

        jTelefono.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jTelefono.setText("Numero de telefono");
        getContentPane().add(jTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, -1, -1));

        jCarrera.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jCarrera.setText("Facultad y Carrera");
        getContentPane().add(jCarrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, -1, -1));

        jSemestre.setFont(new java.awt.Font("Segoe UI Semilight", 3, 14)); // NOI18N
        jSemestre.setText("Nivel de Semestre");
        getContentPane().add(jSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, -1, -1));

        jTitulo.setFont(new java.awt.Font("Segoe UI", 2, 36)); // NOI18N
        jTitulo.setText("REGISTRO ");
        getContentPane().add(jTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, -1, -1));
        ...
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, 160, -1));
        ...
        getContentPane().add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 160, -1));
        ...
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 160, -1));

        jComboBoxCarrera.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ingeniería", "Ciencias de la Salud", "Derecho", "Educación", "Ciencias Económicas y Administrativas", "Psicologia", " " }));
        getContentPane().add(jComboBoxCarrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, 160, -1));

        jComboBoxSemestre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1er", "2do ", "3er", "4to", "5to ", "6to ", "7mo ", "8vo ", "9no ", "10mo " }));
        getContentPane().add(jComboBoxSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 90, -1));
        ...
        getContentPane().add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 580, 130, 30));
        ...
        getContentPane().add(btnBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 580, 130, 30));
        ...
        getContentPane().add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 580, 130, 30));
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 100, 30));
        ...
        getContentPane().add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 290, 30));
        getContentPane().add(Calendario, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 160, 20));
